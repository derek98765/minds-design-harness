...
[showcase/index.html](showcase/index.html) renders every token, component, and composed
section. When unsure whether your output is on-brand, compare it against the showcase
